         ...
         <section className="showcase" style={{backgroundColor: `white`}} > 
            <div className="container-fluid p-0">
                <div className="row g-0">
                    <div className="col-lg-6 order-lg-2 text-white showcase-img" style={{backgroundImage: `url("../../src/assets/bg-showcase-1.jpg")`}}></div>
                ...
                <div className="row g-0">
                    <div className="col-lg-6 text-white showcase-img" style={{backgroundImage: `url("../../src/assets/bg-showcase-2.jpg")`}}></div>
                ...
                <div className="row g-0">
                    <div className="col-lg-6 order-lg-2 text-white showcase-img" style={{backgroundImage: `url("../../src/assets/bg-showcase-3.jpg")`}}></div>
                    <div className="col-lg-6 order-lg-1 my-auto showcase-text">
